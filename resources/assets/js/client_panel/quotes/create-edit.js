...
function initializeSelect2CreateEditQuote () {
    ...
    let editQuoteDueDateFlatPicker = $('#clientEditQuoteDueDate').flatpickr({
        dateFormat: currentDateFormat,
        defaultDate: moment($('#clientEditQuoteDueDate').val()).format(momentFormat),
        'locale': getUserLanguages,
    });
    ...
    $('#client_quote_date').flatpickr({
        ...
        onChange: function (selectedDates, dateStr, instance) {
            let minDate = moment($('#client_quote_date').val(), momentFormat).
                add(1, 'days').
                format(momentFormat);
    ...
    $('#clientEditQuoteDate').flatpickr({
        dateFormat: currentDateFormat,
        defaultDate: moment($('#clientEditQuoteDate').val()).format(momentFormat),
        'locale': getUserLanguages,
        onChange: function () {
            let minDate = moment($('#clientEditQuoteDate').val(), momentFormat).
                add(1, 'days').
                format(momentFormat);
